...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['user_id'])) {
    ...
    if ($conn->query($sql_update) === TRUE) {
        ...
        echo "<script>
            window.location.href = 'http://localhost/first-commit/backend/admin/edit/edit_applicant.php?user_id=$user_id';
        </script>";
        exit();
    } else {
...
<form action="http://localhost/first-commit/backend/admin/edit/edit_applicant.php" method="post">
